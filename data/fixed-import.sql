-- Fixed SQL Import for Game Recharge Platform
-- This file has fixed JSON syntax for PostgreSQL compatibility
...
-- Step 3: Import Sample SKUs (First batch)
...
('sku-3-3', '{"en": "Economic Boost Pack", "zh": "经济加成包"}', '{"en": "+25% resource generation for 7 days. Stackable with other boosts.", "zh": "7天内+25%资源生成。可与其他加成叠加。"}', '{"usd": 1999}', 'https://placehold.co/300x400?text=Economic+Boost&font=serif', 'game-3', NOW(), NOW()),
...
('order-1', 'profile-user-1', 'sku-1-2', 'profile-merchant-1', 999, 'usd', 'completed', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),
