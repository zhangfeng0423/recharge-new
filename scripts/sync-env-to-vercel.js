...
function exportToVercel(envVars, environment = "production") {
  ...
  console.log(`\n🚀 Exporting environment variables to Vercel (${envType})...`);
  ...
  console.log("=".repeat(60));
  console.log(
    `✅ Successfully exported ${exportedCount} environment variables`,
  );
}
...
`;
  ...
  console.log(`📝 Created reference file: ${fileName}`);
}

// Main execution
function main() {
  console.log("🔧 Game Recharge Platform - Environment Variables Sync Tool");
  console.log("=".repeat(60));
  ...
  console.log(
    `📖 Found ${Object.keys(envVars).length} environment variables in .env.local`,
  );
  ...
  rl.question(
    "\n🤔 Do you want to export to (1) Production, (2) Preview/Development, or (3) Both? [1-3]: ",
    (answer) => {
      rl.close();
      ...
      if (choice === "1") {
        ...
        console.log("\n🔄 Exporting to both environments...");
        exportToVercel(envVars, "production");
        exportToVercel(envVars, "preview");
        createVercelEnvFile(envVars, "production");
        createVercelEnvFile(envVars, "preview");
      ...
      console.log("\n📋 Next Steps:");
      console.log(
        "1. Check your Vercel Dashboard for the environment variables",
      );
      console.log(
        "2. Manually add STRIPE_WEBHOOK_SECRET (see .vercel.env file for instructions)",
      );
